...
@Component({
  selector: 'app-historique-demandes-chef',
  imports: [CommonModule, HttpClientModule, FormsModule],
  templateUrl: './historique-demandes-chef.component.html',
  styleUrl: './historique-demandes-chef.component.css'
})
export class HistoriqueDemandesChefComponent implements OnInit {
  ...
  loadDemandes(): void {
    ...
    this.demandeService.getAllDemandesByService().subscribe({
      next: (data: Demande[]) => {
